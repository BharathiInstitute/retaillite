...
function isAdmin(auth, adminsSet, primaryOwner = "kehsaram001@gmail.com") {
    var _a;
    if (!auth || !((_a = auth.token) === null || _a === void 0 ? void 0 : _a.email))
        return false;
...
function isReasonableSize(sizeBytes) {
    return sizeBytes < 500000; // 500KB
}
function canCreateBill(limits) {
    var _a, _b;
    return ((_a = limits.billsThisMonth) !== null && _a !== void 0 ? _a : 0) < ((_b = limits.billsLimit) !== null && _b !== void 0 ? _b : 50);
}
function canAddProduct(limits) {
    var _a, _b;
    return ((_a = limits.productsCount) !== null && _a !== void 0 ? _a : 0) < ((_b = limits.productsLimit) !== null && _b !== void 0 ? _b : 100);
}
function canAddCustomer(limits) {
    var _a;
    if (limits.customersLimit === undefined)
        return false; // deny if missing
    return ((_a = limits.customersCount) !== null && _a !== void 0 ? _a : 0) < limits.customersLimit;
}
// ── Tests ──
describe("User Documents", () => {
    ...
    test("reject doc over 500KB", () => {
        expect(isReasonableSize(600000)).toBe(false);
    });
...
describe("Products Rules", () => {
    ...
    test("can create product within limit", () => {
        const limits = { productsCount: 50, productsLimit: 100 };
        expect(canAddProduct(limits)).toBe(true);
    });
    test("cannot create product beyond limit", () => {
        const limits = { productsCount: 100, productsLimit: 100 };
...
describe("Bills Rules", () => {
    ...
    test("can create bill within limit", () => {
        const limits = { billsThisMonth: 30, billsLimit: 50 };
...
describe("Admin Collections", () => {
    ...
    test("admin can delete other admins", () => {
        const deleteTarget = "other-admin@example.com";
        const requesterEmail = "admin@example.com";
