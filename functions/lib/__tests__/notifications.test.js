...
describe("sendPushNotification", () => {
    ...
    test("removes stale tokens on send failure", () => {
        ...
        const staleTokens = tokens.filter((_, i) => {
            var _a;
            return !responses[i].success &&
                ((_a = responses[i].error) === null || _a === void 0 ? void 0 : _a.code) === "messaging/registration-token-not-registered";
        });
...
describe("checkLowStock", () => {
    ...
    test("default threshold is 5 when not set", () => {
        const lowStockAlert = null;
        const threshold = lowStockAlert !== null && lowStockAlert !== void 0 ? lowStockAlert : 5;
